...
const HomePageLoader = () => {
    return <div>
    <section>
    {/* <ul class="list list-payment" role="list" type="none" style={{display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "10px"}}><li class="list-payment__item">
        ...
        <div className="container my-5 product-page-container">
            <div className="row">
                <div className="col-lg-3 col-md-6 col-sm-6 col-6 placeholder-glow  single-item-container" style={{textDecoration: "none", color: "black"}} onClick={()=>navigateToProduct(product.productName)}>
                    <div className="my-2">
