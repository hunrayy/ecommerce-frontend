...
const Footer = () => {
  ...
  <div class="footer-social">
    ...
    <a href="https://www.instagram.com/beauty_bykiaraa/" target="_blank" class="social-icon"><i class="fa-brands fa-instagram"></i> Instagram</a>
    <a href="https://www.tiktok.com/@beauty_bykiara"  target="_blank" class="social-icon"><i class="fa-brands fa-tiktok"></i> Tiktok</a>
    {/* <a href="#" class="social-icon">YouTube</a> */}
  </div>
  <ul class="list list-payment" role="list" type="none"><li class="list-payment__item">
